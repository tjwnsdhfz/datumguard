...
| 문서 버전 | 1.4.0 |
| 작성일 | 2026-07-12 |
| 제품 단계 | v0.3.0 공개 Production MVP |
...
### 1.1 v0.3.0 release 상태

- Release 기준점: [`v0.3.0`](https://github.com/tjwnsdhfz/datumguard/releases/tag/v0.3.0); 정확한 source SHA와 run·deployment ID는 release notes에 고정
- Release CI: 376 pytest + 35 Playwright + 15-page web build + container/SBOM pass
- Production smoke: 7 public workspace routes, API v0.3.0, exact `release_sha`, FrameGuard·Artifact Lab active, Solid·OpenBIM execution disabled
...
| DG-FR-015 | MCP 도구 | P0 | 하위 호환 9개 도구와 Artifact/Solid 3개 도구, 총 12개가 공통 envelope과 오류코드를 사용한다. |
...
- v0.3.0의 376 pytest와 35 Playwright는 회귀·통합 test evidence이며, FrameGuard의 90-case 합성 solver dataset도 위 100+50 제품 benchmark를 완료한 것으로 계산하지 않는다.
