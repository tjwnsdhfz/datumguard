...
- Pre-case-study evidence 기준점: `b2dd6e5ebd7f21780295f2f37331dadce14eaf68`
- 기준점 CI: [256 pytest + 19 Playwright + container pass](https://github.com/tjwnsdhfz/datumguard/actions/runs/29163874605)
- 기준점 Production smoke: [API v0.2.0, Artifact Lab active, Solid disabled](https://github.com/tjwnsdhfz/datumguard/actions/runs/29163908612)
...
- v0.2.0의 256 pytest와 19 Playwright는 회귀·통합 test evidence이며, 위 100+50 benchmark를 완료한 것으로 계산하지 않는다.
