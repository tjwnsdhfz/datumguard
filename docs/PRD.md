...
| 문서 버전 | 1.3.0 |
| 작성일 | 2026-07-12 |
| 제품 단계 | v0.2.1 공개 Production MVP |
...
### 1.1 v0.2.1 release 상태

- Release 기준점: [`v0.2.1`](https://github.com/tjwnsdhfz/datumguard/releases/tag/v0.2.1); 정확한 source SHA와 run·deployment ID는 release notes에 고정
- Release CI: 256 pytest + 24 Playwright + web/container/SBOM pass
- Production smoke: 6 public product surface, API v0.2.1, exact `release_sha`, Artifact Lab active, Solid disabled
...
- v0.2.1의 256 pytest와 24 Playwright는 회귀·통합 test evidence이며, 위 100+50 benchmark를 완료한 것으로 계산하지 않는다.
